...
export class AdminviewComponent implements OnInit {
  ...
  imagePath: string[] = [ "../assets/ford.jfif", "../assets/bmw.jpg", "../assets/LandRover.jfif", "../assets/clio.jpg", "../assets/bmw.jpg" , "../assets/passat.jfif", "../assets/chevrolet-cruze.jpg", "../assets/205.jpg", "../assets/207.jpg", "../assets/audi.jpg"]; 
